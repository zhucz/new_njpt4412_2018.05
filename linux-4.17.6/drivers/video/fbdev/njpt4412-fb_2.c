...
static int lcd_probe(struct platform_device *pdev)
{
    ...
    s3c_lcd->screen_size    = 272 * 480 * 16 / 8;   //显存大小
    /* 3. 硬件相关的操作 */
    /* 3.1 配置GPIO用于LCD */
    //设备树中使用"default"
    ...
    *(unsigned long *)lcd0_configuration = 0x07;
...
//    temp |= (35 << 16) | (209 << 8)  | (9);
     ...
     */
    writel((479 << 11) | 271, lcd_regs_base + VIDOSD0B);
